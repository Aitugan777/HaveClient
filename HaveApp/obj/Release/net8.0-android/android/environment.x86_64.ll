...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670620, ; uint32_t jnienv_initialize_method_token (0x6001c9c)
	i32 100670619, ; uint32_t jnienv_registerjninatives_method_token (0x6001c9b)
...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 256157890359131699, ; hash 0x38e0e3e7d44fe33, from name: HaveApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 634479670928275127, ; hash 0x8ce1fe62ae2f6b7, from name: libaot-HaveApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 21
	...
	%struct.DSOCacheEntry {
		i64 2450028154205199569, ; hash 0x22003fa01d1b5cd1, from name: HaveApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 70
	...
	%struct.DSOCacheEntry {
		i64 13042357566658903130, ; hash 0xb4ffc31b0254fc5a, from name: aot-HaveApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 411
	...
	%struct.DSOCacheEntry {
		i64 16899886808266826581, ; hash 0xea8875833f0de355, from name: libaot-HaveApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 533
	...
	%struct.DSOCacheEntry {
		i64 17424738854217335068, ; hash 0xf1d11baaed92411c, from name: aot-HaveApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 546
...
@.env.3 = private unnamed_addr constant [37 x i8] c"30376177-1a6c-400c-9dba-5604a510ba94\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.haveapp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-HaveApp.dll.so\00", align 16
