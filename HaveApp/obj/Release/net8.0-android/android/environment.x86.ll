...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1075165685, ; hash 0x4015b9f5, from name: aot-HaveApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1200868557, ; hash 0x4793cccd, from name: HaveApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 152
	...
	%struct.DSOCacheEntry {
		i64 2040087919, ; hash 0x7999456f, from name: aot-HaveApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 273
	...
	%struct.DSOCacheEntry {
		i64 2409733100, ; hash 0x8fa19bec, from name: libaot-HaveApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 335
	...
	%struct.DSOCacheEntry {
		i64 3934504007, ; hash 0xea83c447, from name: libaot-HaveApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 534
	...
	%struct.DSOCacheEntry {
		i64 4038612156, ; hash 0xf0b854bc, from name: HaveApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HaveApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 549
